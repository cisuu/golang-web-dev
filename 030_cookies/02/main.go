...
func set(w http.ResponseWriter, req *http.Request) {
	...
	fmt.Fprintln(w, "in chrome go to dev ool / application / cookies")
}
...
func read(w http.ResponseWriter, req *http.Request) {
	...
	if err != nil {
		...
		fmt.Fprintln(w, "YOUR COOKIR #1:", c1)
	}
	...
	if err != nil {
		...
		fmt.Fprintln(w, "YOUR COOKIR #2:", c2)
	}
	...
	if err != nil {
		...
		fmt.Fprintln(w, "YOUR COOKIR #3:", c3)
	}
}
...
func abundance(w http.ResponseWriter, req *http.Request) {
	...
	http.SetCookie(w, &http.Cookie{
		Name:  "specific",
		Value: "some other value about specifiv cookie",
	})
